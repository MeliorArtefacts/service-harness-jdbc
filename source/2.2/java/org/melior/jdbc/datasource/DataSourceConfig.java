...
public class DataSourceConfig{
    ...
    private int inactivityTimeout = 1800 * 1000;
  ...
  public void setMinimumConnections(
    final int minimumConnections) throws ApplicationException{
      ...
      throw new ApplicationException(ExceptionType.LOCAL_APPLICATION,
        "Minimum number of connections may not be more than maximum.");
    }
  ...
  public void setMaximumConnections(
    final int maximumConnections) throws ApplicationException{
      ...
      throw new ApplicationException(ExceptionType.LOCAL_APPLICATION,
        "Maximum number of connections may not be less than minimum.");
    }
  ...
  /**
   * @param validateOnBorrow the validateOnBorrow to set
   */
